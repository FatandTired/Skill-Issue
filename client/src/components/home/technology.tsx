...
function Technology({
  ...
  return (
    <div
      className={`intersect-once md:intersect:motion-preset-slide-right md:motion-delay-200 bg-primary/20 border border-primary rounded-2xl shadow-[0_0_50px] md:shadow-[0_0_10px] backdrop-blur-xs shadow-primary/50 hover:scale-[103%] active:scale-[99%] hover:shadow-secondary transition-transform duration-400 ease-in-out`}
    >
      <div className={"m-3"}>
        <div
